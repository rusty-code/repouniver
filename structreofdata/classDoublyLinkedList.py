...
# from ..structreofdata import classNode as cnd

import classNode as cnd
...
class DoublyLinkedList:
    ...
    def remove(self, pos : int):
        ...
        else: # WARNING# WARNING# WARNING# WARNING
            """Transfer 'remove inside list' to 'else' block"""
            print("(WARNING) untested remove inside list : UNDEFINED BEHAVIOR")
